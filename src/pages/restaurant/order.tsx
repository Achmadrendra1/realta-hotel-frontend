          ...
          <div className="container mx-auto">
            ...
            <div className="lg:flex">
              <div className="lg:w-3/5 sm:full sm:mb-4 border rounded-lg bg-white shadow p-6 lg:mr-4">
                ...
                <p className="pb-5">We will use these details to share your order information</p>
                <Form layout="vertical">
                  <Form.Item label={"Fullname"}>
                    <Input placeholder="fullname" value={userLoggedIn[0]?.user_full_name} readOnly></Input>
                  </Form.Item>
                  <Form.Item label={"E-mail"}>
                    <Input placeholder="e-mail" value={userLoggedIn[0]?.user_email} readOnly></Input>
                  </Form.Item>
                  <Form.Item label={"No Handphone"}>
                    <Input placeholder="hp" value={userLoggedIn[0]?.user_phone_number} readOnly></Input>
                  </Form.Item>
                </Form>
                  ...
                  <Row gutter={16}>
                    <Col span={8}>
                      <Card
                        ...
                        hoverable
                        onClick={() => {
                          setIsCash(true), setSelectCard({ accNumber: "", balance: "" });
                          setFinalForm({
                            ...finalForm,
                            payType: "C",
                            sourceNumber: 0,
                      ...
                      {isCash ? (
                        <div className="w-full text-center mt-6">
                          <div>
                            ...
                            <p>Your order will be confirmed without any additional fee. Please pay directly at the restaurant when you arrive.</p>
                          </div>
                          <Button onClick={onCompleteCash} className="mt-6 bg-[#754cff] rounded-full text-white w-full h-10">
                            Complete Order
                          </Button>
                        </div>
                      ) : (
                        <div className="mt-6 w-full ">
                          ...
                          {bankAcc.map((item: any) => (
                            <Card
                              ...
                              onClick={() => {
                                ...
                                setFinalForm({
                                  ...finalForm,
                                  payType: item.usacType == "Debet" ? "D" : "CR",
                          ...
                          <p className="mt-2 px-2 cursor-pointer text-[#754cff]" onClick={() => setOpenAdd(true)}>
                            Add New Card
                          </p>
                          <Button disabled={disabled} onClick={onComplete} className="mt-6 bg-[#754cff] rounded-full text-white w-full h-12">
                            Complete Order
                          </Button>
                        </div>
                      )}
              ...
              <div className="lg:w-2/5 sm:w-full border rounded-lg shadow bg-white p-3 sticky top-0 h-1/2 ">
                  ...
                  orderFromUser.map((order: any) => (
                    <div className="border rounded-lg p-2 shadow-md flex my-2">
                      ...
                      <div className="ml-3 mt-1 w-full">
                        <div className="flex">
                          <p className="font-bold w-4/5 text-lg">{order.reme_name}</p>
                        </div>
                ...
                <div className="w-full mx-auto bg-slate-200 rounded-lg my-4 p-4">
                  <p className="font-bold text-center text-xl py-4">Payment Summary</p>
                  <table className="w-full">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="text-right">{orderFromUser[0]?.orme_total_amount}</td>
                      </tr>
                    </tbody>
                  </table>
                  {/* <a onClick={goToBill}>
