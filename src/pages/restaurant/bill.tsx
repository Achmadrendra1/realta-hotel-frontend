      ...
      <main>
        <Layouts>
          ...
          <div className="w-96 mt-4 mb-6 bg-white border rounded-2xl shadow-lg p-4 mx-auto">
            ...
            <p className="text-lg font-semibold text-center uppercase">Hotel Realta</p>
              ...
              <div key={index} className="flex items-center">
                <div className=" mt-1 w-full ml-5">
                  ...
                  <p className="flex ml-6 items-center">
                    {order.orme_price} <span className="text-red-400 ml-4"> x {order.orme_qty}</span>
                    <span className="ml-2 flex">
                      <p className="ml-4 font-semibold text-lg">= {order.orme_subtotal}</p>
                    </span>
                  </p>
                </div>
              </div>
            ...
            <div className="mt-6 mx-4">
              <p className="font-bold text-center text-lg mb-4">Payment Summary</p>
