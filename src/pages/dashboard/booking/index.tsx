...
export default withAuth(function index() {
  const onChange: TableProps<DataBooking>["onChange"] = (pagination, filters, sorter, extra) => {
  ...
  const handleOk = () => {
    setAddBookingOpen(false), setEditBookingOpen(false), setAddBookingFacilitiesOpen(false), setEditBookingFacilitiesOpen(false), setAddSpecialOffersOpen(false), setEditSpecialOffersOpen(false);
  };

  const handleCancel = () => {
    setAddBookingOpen(false), setEditBookingOpen(false), setAddBookingFacilitiesOpen(false), setEditBookingFacilitiesOpen(false);
    setAddSpecialOffersOpen(false), setEditSpecialOffersOpen(false);
  };
    ...
    <Dashboard>
      ...
      <Tabs>
        <Tabs.TabPane tab="Rooms" key="1">
          <div className="text-2xl text-center py-3">Hotel Rooms</div>
          <div className="my-3">
            <Row>
              <Col span={12}>
        ...
        <Tabs.TabPane tab="Facilities" key="2">
          <div className="text-2xl text-center py-3">Hotel Facilities</div>
          <div className="my-3">
            <Row>
              <Col span={12}>
        ...
        <Tabs.TabPane tab="Special Offers" key="3">
          <div className="text-2xl text-center py-3">Special Offers</div>
          <div className="my-3">
            <Row>
              <Col span={12}>
