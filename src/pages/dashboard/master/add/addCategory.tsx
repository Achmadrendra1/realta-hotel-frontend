...
export default function AddCategory(props: any) {
  ...
  return (
    <>
      <Modal title="Add New Category" open={props.show} onOk={props.clickOk} onCancel={props.clickCancel} style={{ top: 20 }} footer={null}>
        <Form layout="vertical" onFinish={onFinish} onFinishFailed={onFinishFailed}>
          <p>
            <Divider style={{ borderWidth: "2px" }} />
          </p>
          <Form.Item style={{ marginTop: "5%" }} label="Group Name" name={"cagroName"} rules={[{ required: true, message: "Please input Group Name!" }]}>
            <Input
              style={{
                width: "80%",
                marginLeft: "10%",
          ...
          <Form.Item style={{ marginTop: "3%" }} label="Type" name={"cagroType"} rules={[{ required: true, message: "Please input Category name!" }]}>
            <Select
              style={{
                width: "80%",
                marginLeft: "10%",
          ...
          <Form.Item style={{ marginTop: "3%" }} label="Descriptions" name={"cagroDescription"} rules={[{ required: true, message: "Please input Description!" }]}>
            <Input.TextArea
              style={{
                width: "80%",
                marginLeft: "10%",
          ...
          <Form.Item label=" " colon={false} style={{ textAlign: "right" }}>
            ...
            <Button htmlType="submit" style={{ marginLeft: "3%  ", marginRight: "1%" }}>
